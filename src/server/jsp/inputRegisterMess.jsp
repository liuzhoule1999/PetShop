	...
	<div id="login">
		...
		<div class="wrapper">
			...
			<div class="login sign-in-htm">
				<form action="index.html" class="container offset1 loginform">
					<!-- 猫头鹰控件 -->
						...
						<section class="content">
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" id="login-username" 
									autocomplete="off" placeholder="请输入用户名" tabindex="1" maxlength="15"  name="logname"/>
					...
					<div class="form-actions">
						...
						<input class="btn btn-primary" type="submit" tabindex="3" onClick="login()" value="登录" 
							style="color:white;" name="g"/>
					</div>
				</form>
			</div>
			<!-- 忘记密码页面 -->
			<div class="login sign-out-htm">
				<form action="loginServlet" method="post" class="container offset1 loginform">
					<!-- 猫头鹰控件 -->
			...
			<div class="login sign-up-htm">
				<form action="registerServlet" method="post" class="container offset1 loginform">
					<!-- 猫头鹰控件 -->
					...
					<div class="pad input-container">
						<section class="content">
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" name="logname" id="register-username" 
								...
								<label class="input__label input__label--hideo" for="register-username">
									...
									<span class="input__label-content input__label-content--hideo"></span>
                                                        ...
                                                        <span class="input input--hideo">
								<input class="input__field input__field--hideo" type="password" name="password" id="register-password" 
									autocomplete="off" placeholder="请输入密码" maxlength="15"/>
								<label class="input__label input__label--hideo" for="register-password">
									...
									<span class="input__label-content input__label-content--hideo"></span>
                                                         ...
                                                         <span class="input input--hideo">
								<input class="input__field input__field--hideo" type="password" name="again_password" id="register-password" 
									autocomplete="off" placeholder="请重新输入密码" maxlength="15"/>
								<label class="input__label input__label--hideo" for="register-password">
									<i class="fa fa-fw fa-lock icon icon--hideo"></i>
									<span class="input__label-content input__label-content--hideo"></span>
								</label>
							...
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" id="register-code" autocomplete="off" value="11111111" name="phone"/>
								<label class="input__label input__label--hideo" for="register-code">
									<i class="fa fa-fw fa-wifi icon icon--hideo"></i>
									<span class="input__label-content input__label-content--hideo"></span>
								</label>
