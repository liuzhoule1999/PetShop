				...
				<form action="registerServlet" method="post" class="container offset1 loginform">
					...
					<div class="pad input-container">
						<section class="content">
							...
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="password" id="register-repassword" placeholder="请确认密码" maxlength="15" name="again_password"/>
								<label class="input__label input__label--hideo" for="register-repassword">
									...
									<span class="input__label-content input__label-content--hideo"></span>
                                                              ...
                                                              <span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" id="register-code" autocomplete="off" value="11111111" placeholder="11111111" name="realname"/>
